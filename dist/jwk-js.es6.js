...
class EC {
    ...
    static JWKfromASN1(asn1, type, extra) {
    ...
    static JWKfromEC(secret, type, extra) {
        return tryPromise(() => {
            const pem = new PEM(secret);
...
class RSA {
    ...
    static JWKfromRSA(secret, type, extra) {
        return tryPromise(() => {
            const pem = new PEM(secret);
    ...
    static verify(bits) {
        return function verify(thing, signature, publicKey) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    return yield RSA.createVerifier('SHA-' + bits)
                        .then(res => res
                        .update(thing)
